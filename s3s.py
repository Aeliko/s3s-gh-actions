...
try:
	...
	CONFIG_DATA = {"api_key": os.environ["API_KEY"], "acc_loc": os.environ["ACC_LOC"], "gtoken": "", "bullettoken": "", "session_token": os.environ["SESSION_TOKEN"], "f_gen": "https://api.imink.app/f"}
